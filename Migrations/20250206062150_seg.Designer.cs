            ...
            modelBuilder.Entity("supercines.Models.funcionesModel", b =>
                {
                    ...
                    b.Property<int?>("peliculasModelIdPelicula")
                        .HasColumnType("int");

                    b.Property<int?>("salasModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("peliculasModelIdPelicula");

                    b.HasIndex("salasModelId");
            ...
            modelBuilder.Entity("supercines.Models.repartosModel", b =>
                {
                    ...
                    b.Property<int?>("personasModelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("supercines.Models.funcionesModel", b =>
                {
                    ...
                    b.HasOne("supercines.Models.peliculasModel", null)
                        .WithMany("Funciones")
                        .HasForeignKey("peliculasModelIdPelicula");

                    b.HasOne("supercines.Models.salasModel", null)
                        .WithMany("Funciones")
                        .HasForeignKey("salasModelId");
            ...
            modelBuilder.Entity("supercines.Models.repartosModel", b =>
                {
                    ...
                    b.HasOne("supercines.Models.personasModel", null)
                        .WithMany("Repartos")
                        .HasForeignKey("personasModelId");
